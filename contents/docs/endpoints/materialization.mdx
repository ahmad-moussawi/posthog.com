...
Insight-based endpoints (Trends, Lifecycle, Retention) return the same response shape whether materialized or not. You can enable or disable materialization without changing your integration code.
